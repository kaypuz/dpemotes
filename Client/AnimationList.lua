...
DP.Shared = {
   ...
   ["ver"] = {"mp_common", "givetake1_a", "Ver", "ver2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 2000
   }},
   ["ver2"] = {"mp_common", "givetake1_b", "Ver 2", "ver", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 2000
   }},
   ...
   ["durkorkarak"] = {"missminuteman_1ig_2", "handsup_base", "Dur (Korkarak)", "stdurdimdikickup", AnimationOptions =
   {
      EmoteMoving = true,
      EmoteLoop = true,
   }},
   ["yumrukat"] = {"melee@unarmed@streamed_variations", "plyr_takedown_rear_lefthook", "Yumruk At", "yumrukye"},
   ["yumrukye"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_cross_r", "Yumruk Ye", "yumrukat"},
   ["kafaat"] = {"melee@unarmed@streamed_variations", "plyr_takedown_front_headbutt", "Kafa At", "kafaye"},
   ["kafaye"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_headbutt", "Kafa Ye", "kafaat"},
   ["tokat2"] = {"melee@unarmed@streamed_variations", "plyr_takedown_front_backslap", "Tokat 2", "tokatye2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
       EmoteDuration = 2000,
   }},
   ["tokat"] = {"melee@unarmed@streamed_variations", "plyr_takedown_front_slap", "Tokat", "tokatye", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
       EmoteDuration = 2000,
   }},
   ["tokatye"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_slap", "Tokat Ye", "tokat"},
   ["tokatye2"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_backslap", "Tokat Ye 2", "tokat2"},
}
...
-----------------------------------------------------------------------------------------------------------
   ...
   ["sandalye"] = {"ScenarioObject", "PROP_HUMAN_SEAT_CHAIR_MP_PLAYER", "Sandalyeye Otur"},
...
-----------------------------------------------------------------------------------------------------
   ...
   ["tepsi"] = {"anim@heists@box_carry@", "idle", "Tepsi", AnimationOptions =
   {
       Prop = "prop_food_bs_tray_03",
       PropBone = 60309,
       PropPlacement = {0.26, 0.07, 0.220, -60.0, 290.5, 0.3},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["tepsi2"] = {"anim@heists@box_carry@", "idle", "Tepsi 2", AnimationOptions =
   {
   ...
   ["tepsi3"] = {"anim@heists@box_carry@", "idle", "Tepsi 3", AnimationOptions =
   {
   ...
   ["ems1"] = {"missheistdocksprep1hold_cellphone", "static", "EMS 1", AnimationOptions =
   {
       Prop = "prop_ld_case_01",
       PropBone = 57005,
       PropPlacement = {0.14, 0.0, 0.0, 0.0, 266.0, 60.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["ems2"] = {"missheistdocksprep1hold_cellphone", "static", "EMS 2", AnimationOptions =
   {
   ...
   ["paraçantası"] = {"impexp_int-0", "mp_m_waremech_01_dual-0", "Para Çantası", AnimationOptions =
   {
       Prop = 'prop_cash_case_02',
       PropBone = 24817,
       PropPlacement = {-0.06, 0.48, -0.01, -180.0, -87.0, 0.0},
       EmoteMoving = true,
       EmoteLoop = true
   }},
   ...
   ["tepsi4"] = {"anim@heists@box_carry@", "idle", "Tepsi 4", AnimationOptions =
   {
